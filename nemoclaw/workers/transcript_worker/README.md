...
## Contract
- **Worker kind:** `transcript_worker`
- **Queue:** `nemoclaw:queue:transcript_worker`
- **DLQ:** `nemoclaw:dlq:transcript_worker`
- **Stateless:** yes
- **Artifact root:** `archive/<task_id>/`

## Required behavior (when implemented)
1. `BLPOP nemoclaw:queue:transcript_worker` to claim a task.
