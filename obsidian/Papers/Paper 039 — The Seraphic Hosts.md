...
`39:0.1` · p.426.1 ^p39-0-1

1. Supreme Seraphim.
`39:0.2` · p.426.2 ^p39-0-2

2. Superior Seraphim.
`39:0.3` · p.426.3 ^p39-0-3

3. Supervisor Seraphim.
`39:0.4` · p.426.4 ^p39-0-4

4. Administrator Seraphim.
`39:0.5` · p.426.5 ^p39-0-5

5. Planetary Helpers.
`39:0.6` · p.426.6 ^p39-0-6

6. Transition Ministers.
`39:0.7` · p.426.7 ^p39-0-7

7. Seraphim of the Future.
`39:0.8` · p.426.8 ^p39-0-8
...
`39:6.1` · p.439.4 ^p39-6-1

1. Seraphic Evangels.
`39:6.2` · p.439.5 ^p39-6-2

2. Racial Interpreters.
`39:6.3` · p.439.6 ^p39-6-3

3. Mind Planners.
`39:6.4` · p.439.7 ^p39-6-4

4. Morontia Counselors.
`39:6.5` · p.439.8 ^p39-6-5

5. Technicians.
`39:6.6` · p.439.9 ^p39-6-6

6. Recorder-Teachers.
`39:6.7` · p.439.10 ^p39-6-7

7. Ministering Reserves.
`39:6.8` · p.439.11 ^p39-6-8
...
`39:8.1` · p.440.3 ^p39-8-1

Seraphim may attain Paradise in scores—hundreds—of ways, but the most important as elaborated in these narratives are the following:
`39:8.2` · p.440.4 ^p39-8-2
...
`39:9.3` · p.442.1 ^p39-9-3

[Presented by a Melchizedek acting by request of the Chief of the Seraphic Hosts of Nebadon.]
`39:9.4` · p.442.2 ^p39-9-4

---
← [[Paper 038 — Ministering Spirits of the Local Universe|Paper 38: Ministering Spirits of the Local Universe]]  ·  [[URANTiOS — Home|Home]]  ·  [[Paper 040 — The Ascending Sons of God|Paper 40: The Ascending Sons of God]] →
