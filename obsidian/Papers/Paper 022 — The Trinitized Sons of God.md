...
`22:0.1` · p.243.1 ^p22-0-1

1. Deity-trinitized Sons.
`22:0.2` · p.243.2 ^p22-0-2

2. Trinity-embraced Sons.
`22:0.3` · p.243.3 ^p22-0-3

3. Creature-trinitized Sons.
`22:0.4` · p.243.4 ^p22-0-4
...
`22:1.1` · p.243.6 ^p22-1-1

1. Mighty Messengers.
`22:1.2` · p.243.7 ^p22-1-2

2. Those High in Authority.
`22:1.3` · p.243.8 ^p22-1-3

3. Those without Name and Number.
`22:1.4` · p.243.9 ^p22-1-4

4. Trinitized Custodians.
`22:1.5` · p.243.10 ^p22-1-5

5. Trinitized Ambassadors.
`22:1.6` · p.243.11 ^p22-1-6

6. Celestial Guardians.
`22:1.7` · p.243.12 ^p22-1-7

7. High Son Assistants.
`22:1.8` · p.243.13 ^p22-1-8
...
`22:7.11` · p.251.1 ^p22-7-11

1. *Ascender-trinitized Sons.* In their creative efforts the finaliters are attempting to trinitize certain conceptual realities of the Almighty Supreme which they have experientially acquired in their ascension through time and space to Paradise.
`22:7.12` · p.251.2 ^p22-7-12
...
`22:10.9` · p.254.6 ^p22-10-9

[Narrated by a Mighty Messenger of the revelatory corps of Orvonton.]
`22:10.10` · p.255.1 ^p22-10-10

---
← [[Paper 021 — The Paradise Creator Sons|Paper 21: The Paradise Creator Sons]]  ·  [[URANTiOS — Home|Home]]  ·  [[Paper 023 — The Solitary Messengers|Paper 23: The Solitary Messengers]] →
