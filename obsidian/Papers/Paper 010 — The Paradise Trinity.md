...
`10:5.3` · p.113.4 ^p10-5-3

1. *Attitude toward the Finite.* The maximum self-limitation of the Trinity is its attitude toward the finite. The Trinity is not a person, nor is the Supreme Being an exclusive personalization of the Trinity, but the Supreme is the nearest approach to a power-personality focalization of the Trinity which can be comprehended by finite creatures. Hence the Trinity in relation to the finite is sometimes spoken of as the Trinity of Supremacy.
`10:5.4` · p.113.5 ^p10-5-4

2. *Attitude toward the Absonite.* The Paradise Trinity has regard for those levels of existence which are more than finite but less than absolute, and this relationship is sometimes denominated the Trinity of Ultimacy. Neither the Ultimate nor the Supreme are wholly representative of the Paradise Trinity, but in a qualified sense and to their respective levels, each seems to represent the Trinity during the prepersonal eras of experiential-power development.
`10:5.5` · p.113.6 ^p10-5-5

3. *The Absolute Attitude* of the Paradise Trinity is in relation to absolute existences and culminates in the action of total Deity.
`10:5.6` · p.113.7 ^p10-5-6
...
`10:6.4` · p.114.5 ^p10-6-4

This group of Trinity Sons embraces the following personalities:
`10:6.5` · p.114.6 ^p10-6-5

1. Trinitized Secrets of Supremacy.
`10:6.6` · p.114.7 ^p10-6-6

2. Eternals of Days.
`10:6.7` · p.114.8 ^p10-6-7

3. Ancients of Days.
`10:6.8` · p.114.9 ^p10-6-8

4. Perfections of Days.
`10:6.9` · p.114.10 ^p10-6-9

5. Recents of Days.
`10:6.10` · p.114.11 ^p10-6-10

6. Unions of Days.
`10:6.11` · p.114.12 ^p10-6-11

7. Faithfuls of Days.
`10:6.12` · p.114.13 ^p10-6-12

8. Perfectors of Wisdom.
`10:6.13` · p.114.14 ^p10-6-13

9. Divine Counselors.
`10:6.14` · p.114.15 ^p10-6-14

10. Universal Censors.
`10:6.15` · p.114.16 ^p10-6-15
...
`10:8.8` · p.116.9 ^p10-8-8

Only infinity can disclose the Father-Infinite.
`10:8.9` · p.117.1 ^p10-8-9

[Sponsored by a Universal Censor acting by authority from the Ancients of Days resident on Uversa.]
`10:8.10` · p.117.2 ^p10-8-10

---
← [[Paper 009 — Relation of the Infinite Spirit to the Universe|Paper 9: Relation of the Infinite Spirit to the Universe]]  ·  [[URANTiOS — Home|Home]]  ·  [[Paper 011 — The Eternal Isle of Paradise|Paper 11: The Eternal Isle of Paradise]] →
