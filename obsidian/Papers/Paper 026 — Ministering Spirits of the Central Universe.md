...
`26:1.1` · p.285.2 ^p26-1-1

The ministering spirits of the grand universe are classified as follows:
`26:1.2` · p.285.3 ^p26-1-2

1. Supernaphim.
`26:1.3` · p.285.4 ^p26-1-3

2. Seconaphim.
`26:1.4` · p.285.5 ^p26-1-4

3. Tertiaphim.
`26:1.5` · p.285.6 ^p26-1-5

4. Omniaphim.
`26:1.6` · p.285.7 ^p26-1-6

5. Seraphim.
`26:1.7` · p.285.8 ^p26-1-7

6. Cherubim and Sanobim.
`26:1.8` · p.285.9 ^p26-1-8

7. Midway Creatures.
`26:1.9` · p.285.10 ^p26-1-9
...
`26:3.4` · p.288.4 ^p26-3-4

2. *The Chief Recorders.* These angels are created on the second circuit but operate everywhere in the central universe. They record in triplicate, executing records for the literal files of Havona, for the spiritual files of their order, and for the formal records of Paradise. In addition they automatically transmit the transactions of true-knowledge import to the living libraries of Paradise, the custodians of knowledge of the primary order of supernaphim.
`26:3.5` · p.288.5 ^p26-3-5
...
`26:3.6` · p.288.6 ^p26-3-6

4. *The Messengers* take origin on circuit number four. They range the Paradise-Havona system as bearers of all messages requiring personal transmission. They serve their fellows, the celestial personalities, the Paradise pilgrims, and even the ascendant souls of time.
`26:3.7` · p.288.7 ^p26-3-7
...
`26:4.2` · p.289.5 ^p26-4-2

1. Pilgrim Helpers.
`26:4.3` · p.289.6 ^p26-4-3

2. Supremacy Guides.
`26:4.4` · p.289.7 ^p26-4-4

3. Trinity Guides.
`26:4.5` · p.289.8 ^p26-4-5

4. Son Finders.
`26:4.6` · p.289.9 ^p26-4-6

5. Father Guides.
`26:4.7` · p.289.10 ^p26-4-7

6. Counselors and Advisers.
`26:4.8` · p.289.11 ^p26-4-8

7. Complements of Rest.
`26:4.9` · p.289.12 ^p26-4-9
...
`26:5.5` · p.291.5 ^p26-5-5

When the work of the outer Havona circle is finished and the course presented is mastered, the pilgrim helpers take their subjects to the pilot world of the next circle and commit them to the care of the supremacy guides. The pilgrim helpers always tarry for a season to assist in making the transfer both pleasant and profitable.
`26:5.6` · p.291.6 ^p26-5-6
...
`26:6.3` · p.292.3 ^p26-6-3

When the supremacy guides deem their pupils ripe for advancement, they bring them before the commission of seventy, a mixed group serving as examiners on the pilot world of circuit number six. After satisfying this commission as to their comprehension of the Supreme Being and of the Trinity of Supremacy, the pilgrims are certified for translation to the fifth circuit.
`26:6.4` · p.292.4 ^p26-6-4
...
`26:7.5` · p.293.3 ^p26-7-5

Seldom does the quest for the Infinite Spirit fail of consummation, and when their subjects have succeeded in this phase of the Deity adventure, the Trinity guides prepare to transfer them to the ministry of the Son finders on the fourth circle of Havona.
`26:7.6` · p.293.4 ^p26-7-6
...
`26:11.3` · p.296.6 ^p26-11-3

Mortals have received the Paradise command: “Be you perfect, even as your Paradise Father is perfect.” To these trinitized sons of the conjoint corps the supervising supernaphim never cease to proclaim: “Be you understanding of your ascendant brethren, even as the Paradise Creator Sons know and love them.”
`26:11.4` · p.297.1 ^p26-11-4
...
`26:11.8` · p.297.5 ^p26-11-8

[Presented by a Perfector of Wisdom from Uversa.]
`26:11.9` · p.297.6 ^p26-11-9

---
← [[Paper 025 — The Messenger Hosts of Space|Paper 25: The Messenger Hosts of Space]]  ·  [[URANTiOS — Home|Home]]  ·  [[Paper 027 — Ministry of the Primary Supernaphim|Paper 27: Ministry of the Primary Supernaphim]] →
