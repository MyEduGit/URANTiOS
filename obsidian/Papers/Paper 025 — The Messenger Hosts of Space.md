...
**Part:** Part I — The Central and Superuniverses  ·  **Author:** One High in Authority
...
`25:0.1` · p.273.1 ^p25-0-1

1. Havona Servitals.
`25:0.2` · p.273.2 ^p25-0-2

2. Universal Conciliators.
`25:0.3` · p.273.3 ^p25-0-3

3. Technical Advisers.
`25:0.4` · p.273.4 ^p25-0-4

4. Custodians of Records on Paradise.
`25:0.5` · p.273.5 ^p25-0-5

5. Celestial Recorders.
`25:0.6` · p.273.6 ^p25-0-6

6. Morontia Companions.
`25:0.7` · p.273.7 ^p25-0-7

7. Paradise Companions.
`25:0.8` · p.273.8 ^p25-0-8
...
`25:4.1` · p.279.2 ^p25-4-1

The Technical Advisers are recruited from the ranks of the following personality orders:
`25:4.2` · p.279.3 ^p25-4-2

1. The Supernaphim.
`25:4.3` · p.279.4 ^p25-4-3

2. The Seconaphim.
`25:4.4` · p.279.5 ^p25-4-4

3. The Tertiaphim.
`25:4.5` · p.279.6 ^p25-4-5

4. The Omniaphim.
`25:4.6` · p.279.7 ^p25-4-6

5. The Seraphim.
`25:4.7` · p.279.8 ^p25-4-7

6. Certain Types of Ascending Mortals.
`25:4.8` · p.279.9 ^p25-4-8

7. Certain Types of Ascending Midwayers.
`25:4.9` · p.279.10 ^p25-4-9
...
`25:8.11` · p.284.4 ^p25-8-11

[Sponsored by One High in Authority from Uversa.]
`25:8.12` · p.284.5 ^p25-8-12

---
← [[Paper 024 — Higher Personalities of the Infinite Spirit|Paper 24: Higher Personalities of the Infinite Spirit]]  ·  [[URANTiOS — Home|Home]]  ·  [[Paper 026 — Ministering Spirits of the Central Universe|Paper 26: Ministering Spirits of the Central Universe]] →
